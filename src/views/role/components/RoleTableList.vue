<template>
  <el-table v-loading="loading" :data="items" class="admin-data-table" stripe>
    ...
    <el-table-column v-if="canEdit || canDelete" label="操作" width="110" fixed="right" align="center">
        ...
        <el-dropdown trigger="click" @command="handleCommand($event, row)">
          ...
          <template #dropdown>
            <el-dropdown-menu>
              ...
              <el-dropdown-item v-if="canDelete" command="delete" :icon="Delete" :disabled="row.admin_count > 0" divided>刪除</el-dropdown-item>
            </el-dropdown-menu>
          </template>
        </el-dropdown>
      </template>
