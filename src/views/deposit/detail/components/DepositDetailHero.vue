<template>
  <section class="deposit-detail-hero">
    <div class="deposit-detail-hero__identity">
      <el-button class="deposit-detail-hero__back" plain :icon="ArrowLeft" @click="$emit('back')" />

      <div class="deposit-detail-hero__title">
        <h1>{{ detail.title }}</h1>
        <p>{{ detail.description }}</p>
      </div>
    </div>

    <div class="deposit-detail-hero__meta">
      <span class="deposit-detail-hero__order">
        入金审核 / <strong>{{ detail.id }}</strong>
      </span>

      <div class="deposit-detail-hero__controls">
        <StatusBadge
          class="deposit-detail-hero__status"
          :label="detail.status"
          :type="detail.statusType"
          :effect="detail.statusEffect"
        />

        <div class="deposit-detail-hero__actions">
