<template>
  <div class="table-list">
    <el-table v-loading="loading" :data="items" class="admin-data-table" stripe
      ><el-table-column prop="order_no" label="訂單號" min-width="180" /><el-table-column
        label="代理"
        min-width="180"
        ...
        ></el-table-column
      ><el-table-column label="金額" min-width="150"
        ><template #default="{ row }"
      ...
      ><el-table-column label="操作" width="100" fixed="right"
        ><template #default="{ row }"
          ><el-button link type="primary" @click="emit('view', row.id)">詳情</el-button></template
        ></el-table-column
      ></el-table
    >
  </div>
