<template>
  <section class="exchange-detail-hero">
    <div class="exchange-detail-hero__identity">
      <el-button
        class="exchange-detail-hero__back"
        plain
        :icon="ArrowLeft"
        @click="$emit('back')"
      />

      <div class="exchange-detail-hero__title">
        <h1>{{ detail.title }}</h1>
        <p>{{ detail.description }}</p>
      </div>
    </div>

    <div class="exchange-detail-hero__meta">
      <span class="exchange-detail-hero__order">
        兑换审核 / <strong>{{ detail.id }}</strong>
      </span>

      <div class="exchange-detail-hero__controls">
        <StatusBadge
          class="exchange-detail-hero__status"
          :label="detail.status"
          :type="detail.statusType"
          :effect="detail.statusEffect"
        />

        <div class="exchange-detail-hero__actions">
