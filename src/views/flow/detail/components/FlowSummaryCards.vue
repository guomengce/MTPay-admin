<template>
  <section class="flow-summary-card">
    <div v-for="item in summaryItems" :key="item.label" class="flow-summary-card__item">
      <span class="flow-summary-card__icon" :class="`is-${item.tone}`">
        <component :is="item.icon" />
      </span>

      <div class="flow-summary-card__body">
...
import { Clock, Money, Switch, UserFilled } from '@element-plus/icons-vue';
